...
<body>
    ...
    <header>
        ...
        <ul class="sidenav menu-responsive sidenav1" id="menu-responsive ">
            ...
            <li><a href="#" onclick="M.toast({html: 'Ya estas aquí!'})"><i class="material-icons left">settings</i>Manufactura</a></li>
    ...
    <main>
        <div class="row container section" style="background-color: rgba(0, 0, 0, 0.5); border-radius: 10px; margin-top: 15px">
            <h4 class="center" style="color: white;">Manufactura</h4>
            <div class="container">
                <div class="row">
                    <div class="col l5 m6 s12 card contenedor" style="margin-right: 30px;">
                        <div class="input-field col s12" id="Articulo">
                            <select class="icons">
                                <option value="" disabled selected>Elige un articulo</option>
                                <optgroup label="Camisas">
                                    <option value="1">Camisa blanca</option>
                                    <option value="2">Camisa negra</option>
                                </optgroup>
                                <optgroup label="Pantalones">
                                    <option value="3">Pantalon negro</option>
                                    <option value="4">Pantalon blanco</option>
                                </optgroup>
                            </select>
                            <label>Articulo</label>
                        </div>
                    </div>
                    <div class="col l3 m6 s12 card contenedor" style="margin-right: 20px;">
                        <div class="input-field col s12">
                            <input id="input_text" type="text" data-length="10">
                            <label for="input_text">Cantidad</label>
                        </div>
                    </div>
                    <div class="col l2 m6 s12 center hide-on-small" style="margin-top: 20px;">
